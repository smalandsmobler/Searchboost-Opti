#!/usr/bin/env node
/**
 * Publicerar AI Overviews/GEO-artikeln till searchboost.se via WordPress REST API.
 * Kör detta skript på EC2 (där SSM-credentials finns tillgängliga via IAM-roll).
 *
 * Körs med:  node scripts/publish-searchboost-ai-overviews.js
 *
...
const htmlRaw = fs.readFileSync(
  path.join(__dirname, '../content-pages/seo-skola/ai-overviews-geo-seo-2026.html'),
  'utf8'
);
...
const ARTICLE = {
  title: 'AI Overviews och GEO — hur det påverkar din SEO 2026',
  slug: 'ai-overviews-geo-seo-2026',
  status: 'publish',
  focus_keyword: 'AI Overviews SEO',
  meta_title: 'AI Overviews och GEO — hur det påverkar din SEO 2026 | Searchboost SEO-skola',
  meta_description: 'AI Overviews förändrar hur Google visar svar. Lär dig vad GEO är, hur AI Overviews påverkar din trafik och vilka 5 strategier som hjälper dig synas i AI-genererade sökresultat.',
  content: bodyContent
};
...
async function main() {
  console.log('=== Searchboost AI Overviews/GEO Publicering ===\n');
