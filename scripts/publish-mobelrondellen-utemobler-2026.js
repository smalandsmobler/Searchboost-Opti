#!/usr/bin/env node
/**
 * Publicerar "Utemöbler 2026"-artikeln till mobelrondellen.se via WordPress REST API.
 * Kör detta skript på EC2 (där SSM-credentials finns tillgängliga).
 *
 * Körs med:  node scripts/publish-mobelrondellen-utemobler-2026.js
 *
...
const ARTICLE = {
  title: 'Utemöbler 2026 — guide till hållbara val för uteplats och altan',
  slug: 'utemobler-2026-guide-hallbara-val',
  status: 'publish',
  focus_keyword: 'utemöbler 2026',
  meta_title: 'Utemöbler 2026 — guide till hållbara val för uteplats | Möbelrondellen',
  meta_description: 'Vilka utemöbler håller i det nordiska klimatet? Vi guidar dig genom material, skötsel och stilar — så att din uteplats ser lika bra ut 2030 som 2026.',
  content: fs.readFileSync(
    path.join(__dirname, '../content-pages/mobelrondellen-utemobler-2026.html'),
    'utf8'
  )
    .replace(/<!--[\s\S]*?-->/g, '')
    .replace(/^[\s\S]*<body[^>]*>/i, '')
...
async function main() {
  console.log('=== Möbelrondellen — Utemöbler 2026 — Publicering ===\n');
