#!/usr/bin/env node
/**
 * Publicerar E-E-A-T-artikeln till searchboost.se via WordPress REST API.
 * Kör detta skript på EC2 (där SSM-credentials finns tillgängliga via IAM-roll).
 *
 * Körs med:  node scripts/publish-searchboost-eeat.js
 *
...
const htmlRaw = fs.readFileSync(
  path.join(__dirname, '../content-pages/seo-skola/eeat-trovardighet-smaforetag.html'),
  'utf8'
);
...
const ARTICLE = {
  title: 'E-E-A-T: Så bygger du trovärdighet som litet företag i Googles ögon',
  slug: 'eeat-trovardighet-smaforetag',
  status: 'publish',
  focus_keyword: 'e-e-a-t',
  meta_title: 'E-E-A-T: Så bygger du trovärdighet som litet företag | Searchboost SEO-skola',
  meta_description: 'E-E-A-T är fyra principer Google använder för att bedöma din sajt. Lär dig konkreta åtgärder för att bygga erfarenhet, expertis, auktoritet och trovärdighet — även om du är ett litet företag.',
  content: bodyContent
};
...
async function main() {
  console.log('=== Searchboost E-E-A-T Publicering ===\n');
