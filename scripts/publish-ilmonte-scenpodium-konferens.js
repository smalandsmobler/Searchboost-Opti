#!/usr/bin/env node
/**
 * Publicerar "Scenpodium för konferenser och företagsevent — 5 saker att tänka på"
 * till ilmonte.se via WordPress REST API.
 *
 * Kör detta skript på EC2 (där SSM-credentials finns tillgängliga via IAM-rollen):
 *   node scripts/publish-ilmonte-scenpodium-konferens.js
 *
...
const rawHtml = fs.readFileSync(
  path.join(__dirname, '../content-pages/ilmonte-scenpodium-konferens-foretagsevent.html'),
  'utf8'
);

const ARTICLE = {
  title: 'Scenpodium för konferenser och företagsevent — 5 saker att tänka på',
  slug: 'scenpodium-konferens-foretagsevent-guide',
  status: 'publish',
  category_id: 1068,
  focus_keyword: 'scenpodium konferens',
  meta_title: 'Scenpodium för konferenser och företagsevent — guide 2026 | Ilmonte',
  meta_description: 'Planerar du en konferens, kick-off eller företagsgala? Läs vår guide om scenpodium för inomhusevent — storlek, höjd, material, logistik och vad som skiljer konferensscener från utomhuspodier.',
...
async function main() {
  console.log('\n=== Publicerar ilmonte-artikel: Scenpodium för konferenser ===\n');
  ...
  console.log('  node scripts/publish-ilmonte-utomhusevenemang.js');
}
