#!/usr/bin/env node
/**
 * Publicerar "Bokhylla guide 2026"-artikeln till mobelrondellen.se via WordPress REST API.
 * Kör detta skript på EC2 (där SSM-credentials finns tillgängliga).
 *
 * Körs med:  node scripts/publish-mobelrondellen-bokhylla-2026.js
 *
...
const ARTICLE = {
  title: 'Bokhylla guide 2026 — så väljer du rätt hyllsystem för ditt hem',
  slug: 'bokhylla-guide-2026',
  status: 'publish',
  focus_keyword: 'bokhylla guide',
  meta_title: 'Bokhylla guide 2026 — välj rätt hyllsystem för ditt hem | Möbelrondellen',
  meta_description: 'Vill du köpa bokhylla 2026? Vi guidar dig steg för steg genom storlekar, material, stilar och organisationstips — för vardagsrum, hall och sovrum.',
  content: fs.readFileSync(
    path.join(__dirname, '../content-pages/mobelrondellen-bokhylla-guide-2026.html'),
    'utf8'
  )
    .replace(/<!--[\s\S]*?-->/g, '')
    .replace(/^[\s\S]*<body[^>]*>/i, '')
...
async function main() {
  console.log('=== Möbelrondellen — Bokhylla guide 2026 — Publicering ===\n');
