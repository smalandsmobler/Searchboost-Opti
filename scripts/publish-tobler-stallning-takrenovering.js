#!/usr/bin/env node
/**
 * Publicerar "Ställning för takrenovering — krav, typer och priser 2026" till tobler.se
...
const rawHtml = fs.readFileSync(
  path.join(__dirname, '../content-pages/tobler-stallning-takrenovering.html'),
  'utf8'
);
...
const ARTICLE = {
  title:            'Ställning för takrenovering — krav, typer och priser 2026',
  slug:             'stallning-takrenovering-krav-typer-priser-2026',
  status:           'publish',
  category_id:      249,   // Branschkunskap
  focus_keyword:    'ställning takrenovering',
  meta_title:       'Ställning för takrenovering — krav, typer och priser 2026 | Tobler',
  meta_description: 'Planerar du att renovera taket? Lär dig vilken ställning som passar, vad reglerna kräver och vad det kostar — komplett guide 2026 från Tobler.',
...
async function main() {
  console.log('\n=== Tobler — Publicerar ställning-takrenovering-artikel ===\n');
