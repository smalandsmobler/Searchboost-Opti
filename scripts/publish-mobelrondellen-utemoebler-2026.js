#!/usr/bin/env node
/**
 * Publicerar "Utemöbler 2026 — Dalarnas klimat"-artikeln till mobelrondellen.se via WordPress REST API.
 * Kör detta skript på EC2 (där SSM-credentials finns tillgängliga).
 *
 * Körs med:  node scripts/publish-mobelrondellen-utemoebler-2026.js
 *
...
const ARTICLE = {
  ...
  slug: 'utemoebler-2026-dalarnas-klimat-guide',
  status: 'publish',
  focus_keyword: 'utemöbler Dalarna',
  meta_title: 'Utemöbler 2026: Vad håller i Dalarnas klimat? | Möbelrondellen Mora',
  meta_description: 'Köpa utemöbler i Dalarna 2026? Lär dig vilket material som tål minusgrader, snö och vår-sol — och se vilka modeller vi rekommenderar hos Möbelrondellen i Mora.',
  content: fs.readFileSync(
    path.join(__dirname, '../content-pages/mobelrondellen-utemoebler-2026-dalarna.html'),
    'utf8'
  )
    .replace(/<!--[\s\S]*?-->/g, '')
    .replace(/^[\s\S]*<body[^>]*>/i, '')
...
async function main() {
  console.log('=== Möbelrondellen — Utemöbler 2026 Dalarna — Publicering ===\n');
