#!/usr/bin/env node
/**
 * Publicerar "Ställningsnät — krav, typer och rätt användning" till tobler.se
...
const rawHtml = fs.readFileSync(
  path.join(__dirname, '../content-pages/tobler-stallningsnät-guide.html'),
  'utf8'
);
...
const ARTICLE = {
  title:            'Ställningsnät — krav, typer och rätt användning på byggarbetsplatsen',
  slug:             'stallningsnät-krav-typer-montering',
  status:           'publish',
  category_id:      249,   // Branschkunskap
  focus_keyword:    'ställningsnät',
  meta_title:       'Ställningsnät — krav, typer och rätt montering | Tobler',
  meta_description: 'Vilka krav ställs på ställningsnät? Vi går igenom nättyper, materialval, regelverk (AFS 2013:4) och hur du monterar rätt skydd på byggarbetsplatsen.',
...
async function main() {
  console.log('\n=== Tobler — Publicerar ställningsnät-artikel ===\n');
