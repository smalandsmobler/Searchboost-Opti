#!/usr/bin/env node
/**
 * Publicerar "Ställningsarbete regler — vad lagen kräver av dig och ditt företag 2026" till tobler.se
 * via WordPress REST API + Rank Math SEO-meta.
 *
 * Körs på EC2 (IAM-rollen ger SSM-åtkomst):
 *   node scripts/publish-tobler-stallningsarbete-regler.js
 *
...
const rawHtml = fs.readFileSync(
  path.join(__dirname, '../content-pages/tobler-stallningsarbete-regler.html'),
  'utf8'
);
...
const ARTICLE = {
  title:            'Ställningsarbete regler — vad lagen kräver av dig och ditt företag 2026',
  slug:             'stallningsarbete-regler-krav-utbildning-besiktning',
  status:           'publish',
  category_id:      249,   // Branschkunskap
  focus_keyword:    'ställningsarbete regler',
  meta_title:       'Ställningsarbete regler — vad lagen kräver av dig och ditt företag | Tobler',
  meta_description: 'Vilka regler gäller för ställningsarbete i Sverige 2026? Lär dig kraven i AFS 2013:4 om montering, besiktning, utbildning och dokumentation — guide från Tobler.',
...
async function main() {
  console.log('\n=== Tobler — Publicerar ställningsarbete-regler-artikel ===\n');
