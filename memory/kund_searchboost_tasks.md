...
> **0 av 3 GSC-kunder checkbara — blockerare kvarstår nu 21 körningar i rad**
...
_Ingen data — Blockerad (2026-06-11, **21 körningar i rad** — 14/16/18/19/20/21/22/23/26/27/28/30 maj + 2/3/5/6/7/8/9/10/11 jun):_
- _EC2-API: Ej nåbar (self-signed TLS, `-k` flag fungerar ej i Envoy-miljön — bekräftad 2026-06-11; HTTP 80 redirectar till HTTPS, port 3000 firewallad)_
...
_Senaste check: 2026-06-11 — 0 kunder checkbara (**21 körningar i rad**)_
