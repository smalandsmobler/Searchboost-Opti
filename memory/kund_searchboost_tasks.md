...
### Veckosammanfattning 2026-06-02 (måndag v23) — LIVE (uppdaterad 2026-06-07)
> **0 av 3 GSC-kunder checkbara — blockerare kvarstår nu 17 körningar i rad (senast kontrollerad 2026-06-07)**
> **ESKALERING NÖDVÄNDIG — 4,5+ veckor utan rankingdata**
...
_Ingen data — Blockerad (2026-06-08, **18 körningar i rad** — 14/16/18/19/20/21/22/23/26/27/28/30 maj + 2/3/5/6/7/8 jun):_
- _EC2-API: Ej nåbar (self-signed TLS, `-k` flag fungerar ej i Envoy-miljön — bekräftad 2026-06-08)_
...
**⚠️ KRITISK BLOCKERARE — 18 MISSADE CHECKS (5 VECKOR UTAN RANKINGDATA)**
...
_Senaste check: 2026-06-08 — 0 kunder checkbara (**18 körningar i rad**)_
