...
- _EC2-API: Ej nåbar från remote environment (self-signed TLS / Envoy-proxy, `-k` fungerar ej — bekräftad 2026-06-11; HTTP 80 redirectar till HTTPS, port 3000 firewallad)_
