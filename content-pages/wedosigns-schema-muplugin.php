...
function sb_wedosigns_service_schema($data, $jsonld) {
    ...
    $services = array(
        ...
        'klistermarken-goteborg'    => array('Klistermärken i Göteborg', 'Klistermärken och dekaler för alla ändamål — produktmärkning, reklam och dekoration.', 'Klistermärken'),
        ...
        'frost-film-goteborg'       => array('Frostad glasfilm i Göteborg', 'Frostad glasfilm för insynsskydd och dekoration. Ger ett elegant frostat uttryck.', 'Frostad glasfilm'),
